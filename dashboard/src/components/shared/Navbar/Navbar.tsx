...
const Navbar = () => {
    ...
    return (
        <nav className=" bg-white sticky top-0 z-50 w-full border-b border-gray-200 py-3">
            <div className="container flex lg:justify-between justify-none">
                <form className="w-1/2 lg:block hidden">
...
<nav className=" bg-white fixed top-0 z-50 w-full border-b border-gray-200 py-3">
            <div className="container flex lg:justify-between justify-none">
                <div className="lg:w-1/4 w-2/3 flex">
                    <button
                        onClick={() => setOpenSideBar(!openSideBar)}
                        type="button"
                        className="items-center text-sm text-green-500 rounded-lg hidden md:inline-flex  lg:inline-flex  hover:bg-transparent focus:outline-none focus:ring-0 focus:ring-gray-200 mr-2 "
                    >
                    ...
                    <Link
                        to="/dashboard/admin"
                        className="text-green-400 font-bold lg:text-3xl text-xl"
                    >
                        Aladin
                    </Link>
                </div>
