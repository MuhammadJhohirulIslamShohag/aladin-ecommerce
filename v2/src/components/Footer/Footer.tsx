    ...
    return (
        <>
            <footer className="bg-gradient-to-tr from-black to-black overflow-hidden relative mt-3">
                ...
                <Image className="shape1" src={"/footer/flower01.png"} alt="Not Available"  height={100} width={100} />
                <Image className="shape2" src={"/footer/flower01.png"}  height={100} width={100} alt="Not Available" />
                <Image
                    className="shape3"
