                    ...
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div className="relative w-full">
                            ...
                            <div className="flex absolute inset-y-0 right-0 items-center pl-3 ">
                                <button type="submit" className="transition-all py-3 px-5 w-full text-sm font-medium text-center text-white rounded-r-lg border cursor-pointer bg-success border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary focus:ring-0 outline-none focus:outline-none focus:ring-success-300 ">Subscribe</button>
                            </div>
                        </div>
